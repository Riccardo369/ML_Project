...
#Do an epoch and return loss function result and accuracy of epoch
...
#Get target - value vector and return accuracy
...
for epoch in range(600):
    ...
    #Do epoch training and learning phase
    nn.fit(dataset.get_dataset(), 0.5,0.0,0.8, dataset.size())
    
    #Calculate performance values
    tr_loss, tr_prec = evaluate_performance(nn,dataset,mse_loss,monk_classification)    #For training
    vl_loss, vl_prec = evaluate_performance(nn,ts_dataset,mse_loss,monk_classification) #For validation
