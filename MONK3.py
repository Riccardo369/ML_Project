...
monk1_tr=Dataset.TakeMonksDataSet("FilesData/monks-3.train")
...
#loading monk dataset
monk1_ts=Dataset.TakeMonksDataSet("FilesData/monks-3.test")
#apply encoding to the dataset
...
simulator=Simulator(
  ...
  grid=parameter_grid.ParameterGrid({
    ...
    "weight_decay":np.array([0.02,0.01,0.1]),
    "momentum":np.array([0.01]),
  }),
